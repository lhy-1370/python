...
################################################################################
## Form generated from reading UI file 'ui_mail.ui'
##
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.table.setGeometry(QRect(20, 20, 711, 561))
        self.lb_title = QLabel(self.centralwidget)
        self.lb_title.setObjectName(u"lb_title")
        self.lb_title.setGeometry(QRect(750, 20, 361, 16))
        self.lb_content = QLabel(self.centralwidget)
        self.lb_content.setObjectName(u"lb_content")
        self.lb_content.setGeometry(QRect(750, 50, 361, 521))

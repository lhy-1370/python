...
################################################################################
## Form generated from reading UI file 'ui_pos.ui'
##
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.lb_now.setGeometry(QRect(10, 10, 271, 16))
        self.label_2 = QLabel(self.centralwidget)
        self.label_2.setObjectName(u"label_2")
        self.label_2.setGeometry(QRect(10, 40, 64, 21))
        self.lcd_num_of_orders = QLCDNumber(self.centralwidget)
        self.lcd_num_of_orders.setObjectName(u"lcd_num_of_orders")
        self.lcd_num_of_orders.setGeometry(QRect(90, 40, 64, 23))
        ...
        self.label_3.setGeometry(QRect(20, 80, 51, 21))
        self.label_4 = QLabel(self.centralwidget)
        self.label_4.setObjectName(u"label_4")
        self.label_4.setGeometry(QRect(20, 120, 51, 21))
        ...
        self.lcd_num_of_orders_processing.setGeometry(QRect(90, 120, 64, 23))
        self.label_5 = QLabel(self.centralwidget)
        self.label_5.setObjectName(u"label_5")
        self.label_5.setGeometry(QRect(20, 160, 51, 21))
        ...
        self.lcd_num_of_orders_delivery.setGeometry(QRect(90, 160, 64, 23))
        ...
        self.lcd_num_of_orders_done.setGeometry(QRect(90, 200, 64, 23))
        self.label_6 = QLabel(self.centralwidget)
        self.label_6.setObjectName(u"label_6")
        self.label_6.setGeometry(QRect(30, 200, 31, 21))
        self.tabWidget = QTabWidget(self.centralwidget)
        self.tabWidget.setObjectName(u"tabWidget")
        self.tabWidget.setGeometry(QRect(190, 40, 811, 541))
        self.tab = QWidget()
        ...
        self.table_orders.setGeometry(QRect(10, 10, 791, 501))
        self.tabWidget.addTab(self.tab, "")
        self.tab_2 = QWidget()
        self.tab_2.setObjectName(u"tab_2")
        self.groupBox = QGroupBox(self.tab_2)
        self.groupBox.setObjectName(u"groupBox")
        self.groupBox.setGeometry(QRect(10, 10, 201, 211))
        self.radio_espresso = QRadioButton(self.groupBox)
        self.radio_espresso.setObjectName(u"radio_espresso")
        self.radio_espresso.setGeometry(QRect(10, 30, 108, 19))
        ...
        self.hs_quantity.setGeometry(QRect(30, 80, 160, 22))
        ...
        self.lb_order_amount.setGeometry(QRect(20, 310, 211, 16))
        self.btn_order = QPushButton(self.tab_2)
        self.btn_order.setObjectName(u"btn_order")
        self.btn_order.setGeometry(QRect(430, 310, 311, 181))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.radio_choco.setText(QCoreApplication.translate("MainWindow", u"\ucd08\ucf54 \uc2a4\ubb34\ub514", None))
        self.radio_strawberry.setText(QCoreApplication.translate("MainWindow", u"\ub538\uae30 \uc2a4\ubb34\ub514", None))
        ...
        self.radioButton_8.setText(QCoreApplication.translate("MainWindow", u"S", None))
